...
\item 9th grade Honors Certificate
\resumeItemListEnd
...
{ Pre-Calculus, Calculus, Linear Algebra, Elementary Graph Theory, Elementary Number Theory, Probability and Statistics, Real Analysis}
...
\small{
    \begin{enumerate}[leftmargin=*,labelsep=2mm]
        \item \textbf{Kamala Omarova}\\
              ...
              \textit{Relationship: Advisor, English teacher}
        \item \textbf{Javanshir Azizov} \\
              Asistant Professor \\
              ADA university \\
              Email: jazizov@ada.edu.az\\
              Phone: \\
              \textit{Relationship: Math teacher}
    \end{enumerate}
}
