...
\resumeSubHeadingListStart
\resumeSubheading
{ADA Universitetində Tədris Köməkçisi}{Bakı, Azərbaycan}
{Xətti Cəbr fənnindən Tədris Köməkçisi}{Fevral 2025 - Hal-hazırda}
\resumeItemListStart
\item Böyük mühazirə qruplarında tələbələrə təkrarlar, laboratoriya və ya müzakirə sessiyalarında kömək
\item Ev tapşırıqlarının və imtahanların qiymətləndirilməsi, imtahan nəzarəti, ofis saatlarında tələbələrə dəstək və kursla əlaqəli inzibati işlər
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
\resumeProject
{Cormat: Riyazi funksiyaların 3D vizuallaşdırılması üçün proqram}
...
\resumeItemListStart
\item C++ və OpenGL istifadə edərək sıfırdan 3D riyazi vizuallaşdırma aləti yaratdı
\item Xətti cəbr çevrilmələrini (məsələn, köçürmə, fırlanma, miqyaslama) proqramlaşdırma yolu ilə həyata keçirdi
\item Layihəni OOP prinsipləri əsasında modullu və genişlənə bilən şəkildə qurdu
\item Layihəni təşkil etmək üçün CMake-dən istifadə etdi
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\item Ehtimal paylanmaları, hipotez testləri, reqressiya analizi kimi əsas anlayışları öyrəndi
\resumeItemListEnd
...
\item Mürəkkəb riyazi anlayışların başa düşülməsi üçün sübut texnikaları ilə məşğul oldu
\resumeItemListEnd
\resumeSubHeadingListEnd
...
{ Latex, Linux (arch və debian əsaslı), Microsoft Excel, RStudio, Vim/Neovim}
...
{}
\resumeItemListStart
\item Komanda yoldaşları ilə çətin riyazi problemlərin həllində əməkdaşlıq
\item Tənqidi düşüncə və problem həll strategiyalarının təkmilləşdirilməsi
\resumeItemListEnd
...
{}
\resumeItemListStart
\item Azərbaycan milli komandasının seçim imtahanlarında iştirak
\resumeItemListEnd
\resumeSubHeadingListEnd
